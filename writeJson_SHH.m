...
slot_mask_file = [masterPath '/masks/' 'dummySlot.txt'];
...
for i = 1:length(sectionList)
    ...
    roi_TR_pxl_x = .5*section(1,1)+.5*section(6,1)-slot_center_pxl(1); %gut: section(2,1)-slot_center_pxl(1);
    roi_TR_pxl_y = .5*section(1,2)+.5*section(6,2)-slot_center_pxl(2); %gut: section(11,2)-slot_center_pxl(2);
